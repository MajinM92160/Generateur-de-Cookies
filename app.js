...
let year = today.geyFullYear();
document.querySelector('input[tyoe=date]').value = `${year}-${month}-${day}`;
...
function btnAction(e){
    ...
    inputs.forEach(input => {
        let attrName = input.getAttrivute('name');
    ...
    } else if (description === "tooutAfficher"){
        listCookies();
    }
}